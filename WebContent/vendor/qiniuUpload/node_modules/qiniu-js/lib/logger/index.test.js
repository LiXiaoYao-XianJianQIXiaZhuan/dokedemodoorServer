...
describe('test logger', function () {
  test('test level', function () {
    ...
    expect(errorMessage).toStrictEqual(['Qiniu-JS-SDK [ERROR][1]: ', 'test3']); // 清空消息
    ...
    expect(errorMessage).toStrictEqual(['Qiniu-JS-SDK [ERROR][2]: ', 'test3']); // 清空消息
    ...
    expect(errorMessage).toStrictEqual(['Qiniu-JS-SDK [ERROR][3]: ', 'test3']); // 清空消息
  ...
  test('test unique id', function () {
    // @ts-ignore
    var startId = _index["default"].id;
    new _index["default"]('', true, 'OFF');
    new _index["default"]('', true, 'OFF');
    var last = new _index["default"]('', true, 'OFF'); // @ts-ignore
