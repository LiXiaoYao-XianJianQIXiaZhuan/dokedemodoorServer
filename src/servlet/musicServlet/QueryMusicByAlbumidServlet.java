...
/**
 * Servlet implementation class QueryMusicByAlbumidServlet
 */
@WebServlet("/QueryMusicByAlbumidServlet")
public class QueryMusicByAlbumidServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QueryMusicByAlbumidServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		musics = ims.queryMusicByAlbumid(albumid);
