 ...
 */
@WebServlet("/UpdateTripByIdServlet")
public class UpdateTripByIdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateTripByIdServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Trip trip = new Trip(id,time,place,title);
		ITripService its = new TripServiceImpl();
		if(its.updateTripById(trip)) {
